      ...
      <main className="flex-grow">
        ...
        <section className="relative bg-gradient-to-r from-plumber-800 to-plumber-700 text-white py-20 overflow-hidden">
          ...
          <div className="container mx-auto px-4 text-center relative z-10">
            <h1 className="text-4xl md:text-5xl font-bold mb-4 fade-in-up">O Nas</h1>
        ...
        <section className="py-16 bg-gradient-to-b from-white to-gray-50">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12 fade-in-up">
              <h2 className="text-3xl font-bold mb-4 text-plumber-800">Dlaczego warto nas wybrać?</h2>
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4">
            <div className="max-w-5xl mx-auto">
              <div className="text-center mb-12 fade-in-up">
                <h2 className="text-3xl font-bold mb-4 text-plumber-800">Nasze podejście</h2>
                <p className="text-lg max-w-3xl mx-auto text-gray-700">
                  Każde zlecenie traktujemy indywidualnie, zawsze stawiając na jakość i zadowolenie klienta.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 stagger-fade-in">
                <div className="bg-gradient-to-br from-plumber-50 to-white p-8 rounded-xl shadow-sm border border-plumber-100">
                  ...
                  <p className="text-gray-700 mb-4">
                    Każde zlecenie traktujemy z najwyższą dbałością o szczegóły, używając materiałów najwyższej jakości. Nie uznajemy kompromisów, gdy chodzi o jakość wykonania.
                  </p>
                  <p className="text-gray-700">
                    Dzięki temu nasze instalacje są trwałe, bezpieczne i estetyczne, a klienci mogą cieszyć się bezproblemowym użytkowaniem przez długie lata.
                  </p>
                </div>
                ...
                <div className="bg-gradient-to-br from-plumber-50 to-white p-8 rounded-xl shadow-sm border border-plumber-100">
                  ...
                  <p className="text-gray-700 mb-4">
                    Oferujemy konkurencyjne ceny z możliwością negocjacji. Zawsze przedstawiamy jasną i szczegółową wycenę przed rozpoczęciem prac, bez ukrytych kosztów.
                  </p>
                  <p className="text-gray-700">
                    Wierzymy, że uczciwe podejście do klienta buduje długotrwałe relacje oparte na zaufaniu i wzajemnym szacunku.
                  </p>
                </div>
                ...
                <div className="bg-gradient-to-br from-plumber-50 to-white p-8 rounded-xl shadow-sm border border-plumber-100">
                  ...
                  <p className="text-gray-700 mb-4">
                    Dotrzymujemy terminów i zawsze stawiamy się na umówione spotkania. Możesz na nas polegać w każdej sytuacji, nawet w nagłych przypadkach.
                  </p>
                  <p className="text-gray-700">
                    Rozumiemy, jak ważna jest niezawodność, szczególnie w przypadku awarii hydraulicznych, które mogą zakłócić normalne funkcjonowanie domu.
                  </p>
                </div>
                ...
                <div className="bg-gradient-to-br from-plumber-50 to-white p-8 rounded-xl shadow-sm border border-plumber-100">
                  ...
                  <p className="text-gray-700 mb-4">
                    Oferujemy fachowe doradztwo w zakresie wyboru odpowiednich rozwiązań hydraulicznych, dostosowanych do indywidualnych potrzeb i budżetu klienta.
                  </p>
                  <p className="text-gray-700">
                    Dzięki naszemu doświadczeniu pomożemy wybrać optymalne rozwiązania, które będą służyć przez lata.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-12 fade-in-up">
              ...
              <p className="text-lg max-w-3xl mx-auto text-white/80">
                Opinie naszych klientów są najlepszym dowodem jakości naszych usług.
              </p>
            </div>
